...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 15h4l-4 6h4l4-6h4l-4 6h4l4-6" />
        <path d="M15 9l-2-6l-2 6" />
        <path d="M3 9h4" />
        <path d="M21 9h-4" />
    </svg>
);
...
export const IdeaIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 18l3-10 3 10M12 22a2.9 2.9 0 003-3 2.9 2.9 0 00-3-3 2.9 2.9 0 00-3 3c0 1.2.6 2.3 1.5 2.8L12 22z" />
        <path d="M8.5 10.5h7" />
        <path d="M12 2v4" />
        <path d="M4 12H2" />
        <path d="M22 12h-2" />
